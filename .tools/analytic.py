...
if __name__ == '__main__':
    ...
    filenames = ['main.py']  # Danh sách các tên tệp cụ thể
    exclude_dirs = ['.tools', 'images', '.venv', 'venv', '__pycache__', 'logs', '.vscode','.git']  # Thư mục cần bỏ qua
    exclude_files = ['README.md','.gitignore', 'requirements.txt', '.dockerignore']  # Tệp cần bỏ qua
